...
### WorkflowCheck.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [WorkflowCheck.Sample.csproj](../WorkflowCheck.Sample/WorkflowCheck.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 
